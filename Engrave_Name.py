...
SIZE_BOARD = [500, 750]     # Size of the image. The image will be scaled keeping its aspect ratio
...
IMAGE_FILE = 'Name1.svg'             # Path of the SVG image, it can be relative to the current RDK station
...
def svg_draw_robot(svg_img, board, pix_ref, item_frame, item_tool, robot):
    ...
    home_joints = [0,0,340,0] # home joints, in deg
...
robot = RDK.Item('Mitsubishi RH-12SH5535')
